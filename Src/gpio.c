...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, STEP_PUL_Pin|STEP_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : STEP_PUL_Pin STEP_DIR_Pin STEP_ENA_Pin */
  GPIO_InitStruct.Pin = STEP_PUL_Pin|STEP_DIR_Pin|STEP_ENA_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
